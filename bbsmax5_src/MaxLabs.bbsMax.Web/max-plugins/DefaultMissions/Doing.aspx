...
<tr>
	<th><h4>任务动作类型</h4>
      <input id="{=$Prefix}Radio1" value="1" name="{=$Prefix}action"  $_form.checked("{=$Prefix}action","1",$out($Values["{=$Prefix}action"])) type="radio" /><label for="{=$Prefix}Radio1">记录心情</label><br />
    </th>
	<td></td>
