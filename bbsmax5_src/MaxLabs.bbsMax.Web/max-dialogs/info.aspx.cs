...
{
    public partial class info : DialogPageBase
    {
        ...
        protected override string DialogReturn
        {
            get
            {
                return "false";
        ...
        protected string m_ReturnValue=null;
        public string ReturnValue
        {
            get
            {
                ...
                if (m_ReturnValue == null)
                  m_ReturnValue = StringUtil.BuildJsonObject( Parameters["ReturnValue"]);
        ...
        public JumpLinkCollection JumpLinkList
        {
            get
            {
                if (m_JumpLinkList == null)
                    m_JumpLinkList = (JumpLinkCollection)Parameters["returnUrls"];

                if (m_JumpLinkList.Count > 0 && m_JumpLinkList[0].IsSystem)
                    m_JumpLinkList.RemoveAt(0);
