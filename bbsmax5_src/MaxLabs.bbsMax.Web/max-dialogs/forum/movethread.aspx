<!--[DialogMaster title="移动主题" subTitle="您共选择了 $ThreadList.count 个主题" width="400"]-->
<!--[place id="body"]-->
...
<div class="clearfix dialogbody">
    <div class="dialogform dialogform-horizontal">
        ...
        <div class="formrow">
            <h3 class="label"><label for="newForumID">目标版块</label></h3>
            <div class="form-enter">
                <select name="newForumID" id="newForumID">
                    <!--[loop $tempForum in $Forums with $i]-->
                    <!--[if $tempForum.ParentID == 0]-->
                    <optgroup label="$tempForum.ForumNameText"></optgroup>
                    <!--[else]-->
                    <option value="$tempForum.ForumID"  $_form.selected("ForumID","$tempForum.ForumID","$out($CurrentForum.ForumID)")>&nbsp;&nbsp;&nbsp;&nbsp;$ForumSeparators[$i]|--$tempForum.ForumNameText</option>
                    <!--[/if]-->
                    <!--[/loop]-->
                </select>
            </div>
            <div class="form-note">红色为没权限的版块</div>
        </div>
        <div class="formrow">
            <div class="form-enter">
            <input type="checkbox" name="iskeeplink" value="true" id="checkbox2" />
            <label for="checkbox2">保持原帖链接</label>
            </div>
        </div>
        <div class="formrow">
...
<div class="clearfix dialogfoot">
    <button class="button button-highlight" name="ok" type="submit" accesskey="y" ><span>确定(<u>Y</u>)</span></button>
