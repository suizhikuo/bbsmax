...
{
    public partial class approvepostsbythreadid : ModeratorCenterDialogPageBase
    {
        ...
        {
            return PostBOV5.Instance.ApprovePostsByThreadIDs(My, ThreadIDs, EnableSendNotify, true, ActionReason);
        }
