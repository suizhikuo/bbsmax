<!--[DialogMaster title="回收主题" subTitle="您共选择了 $ThreadList.count 个主题" width="400" ]-->
<!--[place id="body"]-->
...
<div class="clearfix dialogfoot">
    <button class="button button-highlight" type="submit" name="OK" accesskey="y"><span>确定(<u>Y</u>)</span></button>
