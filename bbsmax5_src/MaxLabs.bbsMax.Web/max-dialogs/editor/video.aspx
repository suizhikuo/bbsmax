...
function check(url) {
//    if (!url.match(/^\w+:\/\/.{3,}\.(mp3|wav|wma|wmv|rm|ra|rmvb|avi|mid|swf|flv)(\?|$)/i)) {
...
<body class="dialogsection-htmleditor">
    <div class="clearfix editordialoghead">
        <div class="editordialogtab">
            <ul class="clearfix">
                <!--[if $ForumId>0]--><li><a href="video.aspx?id=$_get.id&forumid=$Forumid" $_if($_get.tab == null, 'class="current"')>本地上传</a></li><!--[/if]-->
                <li><a href="video.aspx?tab=1&id=$_get.id&forumid=$Forumid" $_if($_get.tab == "1"||$ForumID==0, 'class="current"')>远程文件</a></li>
                <!--[if $EnableNetDiskFunction && $ForumId>0]--><li><a href="video.aspx?tab=3&id=$_get.id&forumid=$Forumid" $_if($_get.tab == "3", 'class="current"')>网络硬盘</a></li><!--[/if]-->
                <!--[if $ForumId>0]--><li><a href="video.aspx?tab=2&id=$_get.id&forumid=$Forumid" $_if($_get.tab == "2", 'class="current"')>历史附件</a></li><!--[/if]-->
            </ul>
        </div>
    ...
    <div class="editordialogbody">
        ...
        <div class="formgroup dialogform remoteinsert  dialogform-horizontal">
            <div class="formrow">
                <h3 class="label"><label for="url">视频地址</label></h3>
            ...
            <div class="formrow">
                ...
                <div class="form-enter">
                    <ul class="optionlist">
                        ...
                        <li>
                            <input type="radio" value="wmv" name="media_type" onclick="if(this.checked)mediaType='wmv'"id="media_type_5" />
                            <label for="media_type_5">WMV</label>
                        </li>
                        <li>
                            <input type="radio" value="rm" name="media_type" onclick="if(this.checked)mediaType='rm'"id="media_type_4" />
                            <label for="media_type_4">RM/RMVB</label>
                        </li>
                        <li>
                            <input type="radio" value="avi" name="media_type" onclick="if(this.checked)mediaType='avi'"id="media_type_6" />
                            <label for="media_type_6">AVI</label>
                        </li>
                    </ul>
                </div>
            </div>
