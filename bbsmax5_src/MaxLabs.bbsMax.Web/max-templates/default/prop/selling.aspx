                            ...
                            <div class="clearfix pagecaption">
                                ...
                                <div class="clearfix pagecaption-body">
                                    <ul class="pagetab">
                                        ...
                                        <li><a class="current" href="$url(prop/selling)"><span>二手市场</span></a></li>
                            ...
                            <div class="clearfix workspace app-prop">
                                <div class="workspace-content">
                                    <div class="clearfix workspace-content-inner">
                                                    ...
                                                    <div class="clearfix propitem-inner">
                                                        <div class="prop-thumb">
                                                            ...
                                                            <div class="prop-owner">
                                                                <span class="fn">$prop.User.PopupNameLink</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="prop-store">
                                                            数量 <strong class="numeric">$prop.SellingCount</strong>
                                                        </div>
                                                        <div class="prop-action">
                                                            <!--[if $prop.User.id != $my.id]-->
                                                            <span class="minbtn-wrap"><span class="btn"><a class="button" href="$Dialog/prop-buy-userprop.aspx?id=$prop.propid&userid=$prop.UserID" onclick="return openDialog(this.href, refresh)">购买</a></span></span>
                                                            <!--[else]-->
                                        ...
                                        <!--[pager skin="../_inc/_pager_app.aspx" count="$TotalPropCount" pagesize="$PropListPageSize" ]-->
                                        <!--[else]-->
                                        <div class="nodata">
                                            暂时没有二手道具.
                                        </div>
