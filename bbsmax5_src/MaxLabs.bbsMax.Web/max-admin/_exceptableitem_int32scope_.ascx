...
<tr>
	<th>
	    ...
	    <p>
	        <input type="text" class="text number" name="{=$name}_minvalue_$index" value="$_form.text('{=$name}_minvalue_$index',$item.Value.MinValue)" /> -
	        <input type="text" class="text number" name="{=$name}_maxvalue_$index" value="$_form.text('{=$name}_maxvalue_$index',$item.Value.MaxValue)" />
	    </p>
<!--[/if]-->
        ...
        <tr>
	        <td>
	            ...
	            <p>
		            <input type="text" class="text number" name="new_{=$name}_minvalue" value="$_form.text('new_{=$name}_minvalue')" /> -
		            <input type="text" class="text number" name="new_{=$name}_maxvalue" value="$_form.text('new_{=$name}_maxvalue')" />
		        </p>
	        </td>
	        <td>
		        <p>排序</p>
