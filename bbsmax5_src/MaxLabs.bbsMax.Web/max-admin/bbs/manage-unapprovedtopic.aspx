    ...
    <form action="$_form.action" method="post" name="topiclistForm" id="topiclistForm">
        ...
        <!--[loop $thread in $ThreadList]-->
                    <tr id="item_$thread.ID">
                        ...
                        <td>
                        <div><a href="$GetThreadUrl($thread)?type=unapprovethreads" target="_blank">$thread.SubjectText</a></div>
                        <div>$GetContent($thread.ThreadID)</div>
                        </td>
                        ...
                        <td>
                        <a href="$dialog/forum/approvethread.aspx?codename=$thread.forum.codename&threadids=$thread.ThreadID" onclick="return openDialog(this.href,this,refresh);">通过审核</a>
