...
<tr>
	<th>
	    ...
	    <p>
	        <select name="{=$name}_value_$index">
	        <!--[loop $EnumItem in $EnumItems]-->
	        <option value="$EnumItem.FieldName" $_form.selected("{=$name}_value_$index","$EnumItem.FieldName","$item.Value")>$EnumItem.Name</option>
	        <!--[/loop]-->
	        </select>
	    </p>
<!--[/if]-->
	    ...
	    <tr>
	        <td>
	            ...
	            <select name="new_{=$name}_value">
		        <!--[loop $EnumItem in $EnumItems]-->
		        <option value="$EnumItem.FieldName" $_form.selected("new_{=$name}_value","$EnumItem.FieldName")>$EnumItem.Name</option>
		        <!--[/loop]-->
		        </select>
            </td>
	        <td>
