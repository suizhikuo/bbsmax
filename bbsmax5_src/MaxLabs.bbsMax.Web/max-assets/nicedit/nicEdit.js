...
var nicEditorConfig = bkClass.extend({
	buttons : {
		...
		'ol': { name: __('数字列表'), command: 'insertorderedlist', tags: ['OL']},
		'ul': { name: __('符号列表'), command: 'insertunorderedlist', tags: ['UL']},
...
var nicLinkOptions = {
	buttons : {
		'link' : {name : '插入超链接', type : 'nicLinkButton', tags : ['A']},
		'unlink' : {name : '删除超链接',  command : 'unlink', noActive : true}
	}
};
/* END CONFIG */
...
var nicImageOptions = {
	buttons : {
		'image' : {name : '插入图片', type : 'nicImageButton', tags : ['IMG']}
	}
...
var nicCodeOptions = {
    buttons: {
        'xhtml': { name: '编辑源代码', type: 'nicCodeButton' }
    }
