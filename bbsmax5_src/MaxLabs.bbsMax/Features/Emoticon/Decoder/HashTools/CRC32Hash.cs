...
{
	public class CRC32Hash : HashModule
	{
		private uint m_crc32 = 0;

		// CRC-32 polynominal:
		// X^32+X^26+X^23+X^22+X^16+X^12+X^11+X^10+X^8+X^7+X^5+X^4+X^2+X+1
		private static uint[] pCRC32Tab = {
		...
		public uint GetRawCRC32Value() { return m_crc32; }
		...
		{
			strName = "CRC-32 / FCS-32";
			strShortName = "CRC-32";
			strRef = "ISO 3309, ITU-T V.42, ANSI X3.66, FIPS PUB 71";
			uHashSize = 32;
			uInternalBufferSize = 32;

			pbFinalHash = new byte[4];
			return true;
		}
        ...
        //public override void UpdateHash(byte[] data, int offset, int count)
        //{
        //    for (int i = offset; i < count; i++)
        //        m_crc32 = (m_crc32 >> 8) ^ pCRC32Tab[data[i] ^ (m_crc32 & 0xFF)];
        //}
		...
		{
			Store32H(pbFinalHash, ~m_crc32);
		}

        //public override uint Test()
        //{
        //    byte[] pb;
        //    byte[] r1 = { 0x2B, 0x58, 0xBA, 0xC9 };
        //    byte[] r2 = { 0x1f, 0xc2, 0xe6, 0xd2 };
        //    byte[] r3 = { 0x7c, 0xa9, 0x4a, 0x72 };
        //    byte[] r4 = { 0x4c, 0x27, 0x50, 0xbd };

        //    pb = StringToAsciiEx("abcabcabcabcabcabcabcabcabcabcabcabcabcabcabc");
        //    if(!HashAndCompare(pb, r1)) return 1;
			
        //    pb = StringToAsciiEx("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
        ...
        //    pb = StringToAsciiEx("abcdefghijklmnopqrstuvwxyz");
