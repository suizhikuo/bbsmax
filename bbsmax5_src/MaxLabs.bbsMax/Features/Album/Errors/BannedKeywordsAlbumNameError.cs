...
{
    public class AlbumNameBannedKeywordsError : ErrorInfo
    {
        public AlbumNameBannedKeywordsError(string target, string keyword)
            : base(target)
        {
            Keyword = keyword;
        }
        ...
        public override string Message
        {
            get {
                if (IsShowKeywordContent)
                    return "相册名称包含了被禁止的关键字：" + Keyword;
                else
                    return "相册名称包含了被禁止的关键字.";
                }
        }
