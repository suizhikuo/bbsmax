...
{
    public class HashedTimeLimitCollectionBase<TK, TV, TCollection> : HashedCollectionBase<TK, TV>
        where TK : IComparable<TK>
        where TV : IPrimaryKey<TK>, ITimeLimit
        where TCollection : HashedTimeLimitCollectionBase<TK, TV, TCollection>, new()
    {
